<%@ Page Language="C#" MasterPageFile="~/TrangChu.Master" AutoEventWireup="true" CodeBehind="TrangChu.aspx.cs"  Title="Thời Trang" %>

<%--Inherits="DoAn4.WebForm1"--%>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Con1" runat="server">
    <div>
<embed src="file.swf" quality="high" type="application/x-shockwave-flash" 
